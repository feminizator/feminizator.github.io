...
FEM.endings = {
	...
	'иха'  : [
			...
			['рк', 0], //кварк -> кваркиха
			['о[гдтн]', 0], //гот -> готиха, адрон -> адрониха, биолог -> биологиха, метод -> методиха
			['у[дп]', 0], //труп -> трупиха, сосуд -> сосудиха
			['уй', 1] //буй -> буиха
		],
	'иня'  : [
			['[аеёов]р', 0],
	...
	'есса' : [
			...
			['о[ндг]', 0], //метод -> методесса, адрон -> адронесса, биолог -> биологесса
			['р[гк]', 0], //кварк -> кваркесса
			['ст', 0], //специалист -> специалистесса
			['у[дпнх]', 1],  //сосуд -> сосудесса, колдун -> колдунесса, олух -> олухесса
			['уй', 0], //буй -> буесса
	...
	'ица'  : [
			...
			['у[днпч]', 0], //сосуд -> сосудица, колдун -> колдуница, труп -> трупица
			['уй', 1], //буй -> буица
