...
FEM.endings = {
	...
	'иха'  : [
			...
			['ог', 0], //биолог -> биологиха
			['ач', 0], //врач -> врачиха
			['ль', 1], //создатель -> создателиха
			['ил', 0], //библиофил -> библиофилиха
			['од', 0], //метод -> методиха
			['ец', 2], //канадец -> канадиха
			['у[пй]', 1],  //буй -> буиха
			['ир', 0] //командир -> командириха
		],
	'иня'  : [
			['[аеёов]р', 0],
			['[ои]к', 0],
	...
	'есса' : [
			...
			['от', 0], //гот -> готесса
			['эт', 0], //поэт -> поэтесса
			['у[нх]', 0], //колдун -> колдунесса, олух -> олухесса
			['ен', 0], //член -> членесса
			['нь', 1], //камень -> каменесса
			['во', 1], //существо -> существесса
			['у[йп]', 1],  //буй -> буесса,
			['ир', 0] //командир -> командиресса
		],
	'ица'  : [
			['[аеёов]р', 0],
			['уч', 0],
			...
			['ил', 0],  //библиофил -> библиофилица
			['во', 1], //существо -> существица
			['у[йп]', 1],  //буй -> буица
			['ир', 0] //командир -> командирица
		],
	'ница' : [
